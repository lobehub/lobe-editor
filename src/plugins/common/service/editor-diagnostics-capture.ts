...
import type { BaseSelection, EditorState, LexicalEditor, PointType } from 'lexical';
import { $getSelection, $isNodeSelection, $isRangeSelection } from 'lexical';

import { EDITOR_THEME_KEY, getKernelFromEditor, noop } from '@/editor-kernel';
...
type EditorDiagnosticsEntryMetadata = {
...
/**
 * The opt-in collector behind the lightweight service facade. The facade
 * owns the early command bridge; this module owns DOM, selection, and update
 * snapshots and is loaded only after diagnostics are enabled.
 */
export class EditorDiagnosticsCapture {
