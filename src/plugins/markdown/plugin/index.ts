...
export const MarkdownPlugin: IEditorPluginConstructor<MarkdownPluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<MarkdownPluginOptions> {
        ...
        onInit(editor: LexicalEditor): void {
            console.info('MarkdownPlugin: Initializing Markdown Plugin');
