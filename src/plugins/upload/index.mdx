...
const unregisterImageUpload = uploadService.registerUpload(async (file, from, range) => {
...
// Keep the disposer with the owning plugin/editor and call it during teardown.
const disposeImageUpload = () => unregisterImageUpload();
