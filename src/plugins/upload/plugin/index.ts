...
export const UploadPlugin: IEditorPluginConstructor<UploadPluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<UploadPluginOptions> {
        static readonly pluginName = 'upload';

        constructor(protected kernel: IEditorKernel, public config?: UploadPluginOptions) {
            super();
            ...
            this.register(editor.registerCommand(
                ...
                (event) => {
                    ...
                    if (dataTransfer && dataTransfer.files.length > 0) {
                        ...
                        if (uploadService) {
                            uploadService.uploadFile(file, 'drop')
                                .catch((error) => {
