...
export const ImagePlugin: IEditorPluginConstructor<ImagePluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<ImagePluginOptions> {
        static readonly pluginName = 'image';

        constructor(protected kernel: IEditorKernel, public config?: ImagePluginOptions) {
            super();
