...
```markdown
<https://example.com> → Highlighted link <user@example.com> → Highlighted email link
```
...
```markdown
Check out <https://www.google.com.hk/> for more info. Visit <mailto:support@example.com> for help.
```
