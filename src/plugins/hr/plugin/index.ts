...
export const HRPlugin: IEditorPluginConstructor<HRPluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<HRPluginOptions> {
        static pluginName = "HRPlugin";

        constructor(protected kernel: IEditorKernel, config?: HRPluginOptions) {
            super();
            ...
            kernel.registerDecorator('horizontalrule', (node: DecoratorNode<any>, editor: LexicalEditor) => {
        ...
        onInit(_editor: LexicalEditor): void {
            console.info('HRPlugin: Initializing Horizontal Rule Plugin');
        }
    }