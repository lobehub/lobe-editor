...
import { $createParagraphNode, $insertNodes, $isRootOrShadowRoot, DecoratorNode, LexicalEditor } from "lexical";
...
export const FilePlugin: IEditorPluginConstructor<FilePluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<FilePluginOptions> {
        static pluginName = "FilePlugin";

        constructor(protected kernel: IEditorKernel, public config?: FilePluginOptions) {
            super();
