...
import { ListItemNode, ListNode, registerList, registerListStrictIndentTransform } from "@lexical/list";
import { $indentOverTab, listReplace } from "../utils";
import { $getSelection, $isRangeSelection, COMMAND_PRIORITY_EDITOR, INDENT_CONTENT_COMMAND, INSERT_TAB_COMMAND, KEY_TAB_COMMAND, LexicalCommand, LexicalEditor, OUTDENT_CONTENT_COMMAND } from "lexical";
...
export const ListPlugin: IEditorPluginConstructor<ListPluginOptions> =
    class extends KernelPlugin implements IEditorPlugin<ListPluginOptions> {
        ...
        onInit(editor: LexicalEditor): void {
            ...
            this.register(editor.registerCommand<KeyboardEvent>(
                KEY_TAB_COMMAND,
                (event) => {
