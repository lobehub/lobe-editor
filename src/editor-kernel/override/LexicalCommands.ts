...
export const OUTDENT_CONTENT_COMMAND: LexicalCommand<void> =
  createCommand('OUTDENT_CONTENT_COMMAND');
 ...
 */
export const COPY_COMMAND: LexicalCommand<ClipboardEvent | KeyboardEvent | null> =
 ...
 */
export const CUT_COMMAND: LexicalCommand<ClipboardEvent | KeyboardEvent | null> =
